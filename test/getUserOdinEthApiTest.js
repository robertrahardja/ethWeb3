...
describe('User\'s Odin and Eth Balances API. getUserODinEthApiTest.js', () => {
    describe('Post: /getUsrOdinEthBal. Input: userAddress', () => {
        ...
        it('API should return status 200 and error message stating invalid address. Input: userAddress =\'hi\'', () => {
            chai.request(server)
                .post('/getUsrOdinEthBal')
                .set('content-type', 'application/x-www-form-urlencoded')
                .type('form')
